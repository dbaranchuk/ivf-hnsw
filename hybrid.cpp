...
//#pragma omp critical
    ...
    std::cout << "[Global Baseline] Average Error: " << baseline_error / total_groupsizes << std::endl;
    std::cout << "[Global Modified] Average Error: " << modified_error / total_groupsizes << std::endl;
