                       ...
                       const int vecdim, const int efConstruction, const int M, const int M_PQ)
{
    ...
    if (exists_test(path_info) && exists_test(path_edges)) {
        ...
        HierarchicalNSW<dist_t, vtype> *hnsw = new HierarchicalNSW<dist_t, vtype>(l2space, "/sata2/dbaranchuk/to_vision/deep4m_ef500_clusters3993883_M16_hnsw_reverse.bin",
        "/sata2/dbaranchuk/to_vision/centroids4M_reverse.fvecs", "/sata2/dbaranchuk/to_vision/deep4m_ef500_clusters3993883_M16_hnsw_reverse.ivecs");
        appr_alg->merge(hnsw);
        delete hnsw;
