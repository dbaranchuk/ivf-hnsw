                       ...
                       const int vecdim, const int efConstruction, const int M, bool one_layer)
{
    ...
    const map<size_t, pair<size_t, size_t>> M_map = {{100000000, {16, 32}}, {200000000, {12, 24}}, {400000000, {8, 16}}, {vecsize, {5, 8}}};
    ...
    //const map<size_t, pair<size_t, size_t>> M_map = {{100000000, {16, 32}},{200000000, {12, 24}},{300000000, {8, 16}},{vecsize, {6, 10}}};
