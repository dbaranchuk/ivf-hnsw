...
void sift_test1B()
{
	...
	size_t vecsize = subset_size_milllions * 1000000; // remove clustersize
	size_t qsize = 10000;
	size_t vecdim = 128;
    ...
    sprintf(path_index, "/sata2/dbaranchuk/synthetic_100m_5m/sift100m_ef_%d_M_%d_test_base.bin", efConstruction, M);
